                ...
                entries.map((item) => {
                  ...
                  return (
                    <div
                      ...
                      className={`group p-4.5 sm:p-5 rounded-2xl border transition-all cursor-pointer ${
                        isDark
                    ...
                    >
                        ...
                        >
                          ...
                          {onDeleteNote && (
                            <button
                              ...
                              className="p-1.5 rounded-full text-neutral-400 hover:text-rose-500 hover:bg-rose-500/10 transition-colors"
                            >
                      ...
                      {item.content && (
                        <p className={`text-[14px] sm:text-[15px] line-clamp-3 leading-relaxed mb-3 ${
                          isDark ? 'text-neutral-300' : 'text-neutral-600'
                        }`}>
                          {stripHtml(cleanNoteTextForPreview(item.content))}
                        </p>
                      )}

                      <div className="flex items-center justify-between text-xs text-neutral-400 pt-2 border-t border-white/[0.06] dark:border-white/[0.06] border-neutral-100">
